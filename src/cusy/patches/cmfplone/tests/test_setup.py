...
from cusy.patches.cmfplone.testing import (
    CUSY_PATCHES_CMFPLONE_INTEGRATION_TESTING  # noqa: E501,
)
...
class TestSetup(unittest.TestCase):
    ...
    layer = CUSY_PATCHES_CMFPLONE_INTEGRATION_TESTING
    ...
    def test_browserlayer(self):
        ...
        from cusy.patches.cmfplone.interfaces import (
            ICusyPatchesCmfploneLayer)
